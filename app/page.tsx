  ...
  return (
    <div className="flex flex-col w-full items-center fancy-overlay">
      ...
      <LandingPrimaryImageCtaSection
        title="Mindmekka – motivate.educate. elevate"
        description="Happily serving more than 150 000 entrepreneurs, small business owners, freelaners, designers, and digitalmarketers from around the globe"
      ...
      >
        <Button size="xl" asChild>
          <Link href="/mindmekka0-benefitts">Learn More</Link>
        </Button>
      ...
      <LandingProductFeature
        title="Personalized Growth Pathways"
        descriptionComponent={
          <>
            <p>
              Discover curated learning experiences that adapt to your unique
              goals and challenges, guiding you step-by-step towards success.
            </p>
      ...
      <LandingProductFeature
        ...
        descriptionComponent={
          <>
            <p>
              Mindmekka's platform features a clean, user-friendly layout,
              allowing you to focus on your learning without distractions while
      ...
      <LandingProductFeature
        ...
        descriptionComponent={
          <>
            Transform your dreams into reality with Mindmekka's tailored
            resources.
            <Button asChild variant="outlinePrimary">
              <Link href="/read-more">Read more</Link>
            </Button>
      ...
      <LandingSaleCtaSection
        ...
        description="Become a part of a network of over 150,000 like-minded individuals who are passionate about growth and innovation. Sign up today and take the first step toward building the future you've always envisioned."
        ctaHref={'#'}
